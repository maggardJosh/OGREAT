...
public class FutilePlatformerBaseObject : FContainer
{
    ...
    public bool collidesWithOtherObjects = true;
    ...
    public float StateCount { get { return stateCount; } set { stateCount = value; } }
    ...
    private bool TryMoveRight(float amount, bool checkObjects = true)
    {
    ...
    private bool TryMoveLeft(float amount, bool checkObjects = true)
    {
        float newX = this.x + amount;
        float lastX = x;
        while (x > newX)
    ...
    private bool TryMoveDown(float amount, bool checkObjects = true)
    {
    ...
    private bool TryMoveUp(float amount, bool checkObjects = true)
    {
        grounded = false;
