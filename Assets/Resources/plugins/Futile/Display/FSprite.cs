...
public class FSprite : FFacetElementNode
{
	...
	virtual public float width
	{
        ...
        set { _scaleX = value / _textureRect.width; _isMatrixDirty = true; HandleElementChanged();  } 
	}
	
	virtual public float height
	{
		get { return _scaleY * _textureRect.height; }
        set { _scaleY = value / _textureRect.height; _isMatrixDirty = true; HandleElementChanged();  } 
	}
